...
class TrainModel:
    def __init__(self, num_layers, width,width_decrease,batch_size, learning_rate, input_dim_weight,input_dim_height, output_dim):
        ...
        self.model = self._build_model(num_layers, width,width_decrease)
    ...
    def _build_model(self, num_layers, width,width_decrease):
        ...
        # conv_outputs = layers.Conv2D(8,(3,3),activation='relu')(inputs)
        # flatten_output = layers.Flatten()(conv_outputs)
